...
def main(input_dir_A, input_dir_B, output_dir_A, output_dir_B):
    ...
    weights_file = '/workspace/code/deeplabv3plus_23-0.99037--0.97981_m3.hdf5'
    ...
    for n, input_dir in enumerate(input_dir_list):
        ...
        for seq in names:
            ...
            # image_256, img_black, img_shape, pad_shape = load_and_preprocess_image_change_256(hh_file, hv_file, vh_file, vv_file)
            ...
            # rgb_origin = mask_to_rgb_black(img_origin, img_shape)
            rgb_origin = mask_to_rgb_black_imfill_whole(img_origin, img_shape)
