...
class mySegNet(object):
    ...
    def __init__(self, img_rows=256, img_cols=256, drop_rate=0.5, n_labels=5, num_class=5, pretrained_weights=None):
    ...
    def create_test_data(self):
        sar_filename = self.load_sample(sar_dir='/emwusr/xianzhengshi/2020_test/20200404/sar_seg/sar_256_test')
    ...
    def train(self):
        ...
        model = segnet(4)
        path = '/emwusr/xianzhengshi/2020_test/research_compare/segnet_weights_4/segnet_val_acc.hdf5'
        ...
        # model.load_weights('deeplabv3_xception_tf_dim_ordering_tf_kernels.h5', by_name=True)
        # model.summary()
        weights_file = '/emwusr/xianzhengshi/2020_test/research_compare/segnet_weights_4/'
        ...
        io.savemat(weights_file + 'test_predict_val_acc_lab_wuhan', {'name': test_pre})
