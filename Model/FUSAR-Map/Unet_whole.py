...
from Unet_weights import get_unet
...
class myUNet(object):
    ...
    def train(self):
        ...
        model = get_unet(input_shape=(256, 256, 3), classes=self.num_class)
        ...
        model_checkpoint = ModelCheckpoint('./2020_test/research_compare/unet_weights_4/unet_val_acc.hdf5', monitor='val_acc', verbose=1,
                                           save_best_only=True, save_weights_only=True)
        model_checkpoint1 = ModelCheckpoint('./2020_test/research_compare/unet_weights_4/unet_train_loss.hdf5', monitor='loss', verbose=1,
                                            save_best_only=True, save_weights_only=True)
        model_checkpoint2 = ModelCheckpoint('./2020_test/research_compare/unet_weights_4/unet_val_loss.hdf5', monitor='val_loss', verbose=1,
                                            save_best_only=True, save_weights_only=True)
