...
class myUNet(object):
    ...
    def train(self):
        ...
        path = '/emwusr/xianzhengshi/2020_test/research_compare/unet_weights_4/unet_train_loss.hdf5'
        ...
        # model.load_weights('deeplabv3_xception_tf_dim_ordering_tf_kernels.h5', by_name=True)
        # model.summary()
        weights_file = '/emwusr/xianzhengshi/2020_test/research_compare/unet_weights_4/'
        ...
        io.savemat(weights_file + 'test_predict_train_loss_lab_wuhan', {'name': test_pre})
